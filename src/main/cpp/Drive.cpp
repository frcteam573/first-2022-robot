...
/* CLIMBING */
        ...
        int Drive::climber_extend(){
            ...
            if(s_leftclimber_enc->GetPosition() < 170){

                double k_c = 0.01;
                double err = 171 - s_leftclimber_enc->GetPosition();
            ...
            if(s_rightclimber_enc->GetPosition() > -170 ){

                double k_c = 0.01;
                double err = -171 - s_rightclimber_enc->GetPosition();
...
void Drive::reset_drive_s(){
    ...
    int Drive::climber_extend_nolimit_left(){
        ...
        int Drive::climber_retract_nolimit_left(){
    ...
    int Drive::climber_extend_nolimit_right(){
        ...
        int Drive::climber_retract_nolimit_right(){
        ...
        void Drive::climber_off_left(){
                climb_lock = 0;
            
                m_leftclimb -> Set(0);
        }
        void Drive::climber_off_right(){
                climb_lock = 0;
